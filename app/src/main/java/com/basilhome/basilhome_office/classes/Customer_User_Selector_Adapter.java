...
public class Customer_User_Selector_Adapter extends RecyclerView.Adapter<Customer_User_Selector_Adapter.ViewHolder> {
    Context context;


    private ArrayList<Customer> os_version;

    public Customer_User_Selector_Adapter(ArrayList<Customer> arrayList) {
        os_version = arrayList;
    }

    @Override
    public Customer_User_Selector_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final Customer_User_Selector_Adapter.ViewHolder holder, int position)  {
